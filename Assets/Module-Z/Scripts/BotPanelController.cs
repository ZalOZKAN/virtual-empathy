...
/// <summary>
/// GuideCanvas yöneticisi.
/// S1 — Karakter seçimi (sprite butonlar)
/// S2 — İlk izlenim sorusu
/// S3 — Geçiş yanıtı + Devam Et
/// </summary>
public class BotPanelController : MonoBehaviour
{
    ...
    [Header("S1 — Karakter Sprite Butonları")]
    ...
    void Awake()
{
    ...
    {
         Debug.Log("[BotPanel] ShowCharacterSelect çağrıldı");
        questionText.text =
    ...
    public void OnCharSelected(int index)
{
    ...
    void ShowTransition()
    {
        ...
        // Ses bitince + 0.5sn "Devam Et" göster
        float delay = (botVoice != null && responseClip != null)
            ? responseClip.length + 0.5f
            : 2f;
